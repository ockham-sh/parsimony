...
@connector(output=_SEARCH_OUTPUT, tags=["eodhd", "search", "tool"])
...
@connector(output=_EXCHANGES_OUTPUT, tags=["eodhd", "search", "tool"])
...
@connector(output=_EXCHANGE_SYMBOLS_OUTPUT, tags=["eodhd", "search"])
...
@connector(tags=["eodhd", "equity"], result_type="dict")
...
@connector(output=_SCREENER_OUTPUT, tags=["eodhd", "equity", "search", "tool"])
