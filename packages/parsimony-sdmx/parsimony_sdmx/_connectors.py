...
@connector(tags=["sdmx"])
async def sdmx(params: SdmxFetchParams) -> Result:
...
@connector(tags=["sdmx", "search", "tool"])
...
CONNECTORS = Connectors([sdmx, sdmx_list_datasets, sdmx_dsd, sdmx_codelist, sdmx_series_keys])
