...
├── result.py           Result + Provenance + OutputSpec + Column + ColumnRole.
├── catalog/            Catalog runtime, indexes, filters, search helpers, snapshot I/O.
├── catalog/filters.py  Filter/F/all_of/any_of — the composable filter contract.
