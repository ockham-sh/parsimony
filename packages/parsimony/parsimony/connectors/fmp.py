...
@connector(output=SEARCH_OUTPUT, tags=["equity", "utility", "search", "tool"])
...
@connector(tags=["equity", "utility", "search", "tool"])
...
@connector(output=PEERS_OUTPUT, tags=["equity", "search", "tool"])
async def fmp_peers(
    params: FmpSymbolParams,
    *,
    api_key: str,
...
@connector(output=INDEX_CONSTITUENTS_OUTPUT, tags=["equity", "search", "tool"])
...
@connector(output=MARKET_MOVERS_OUTPUT, tags=["equity", "search", "tool"])
