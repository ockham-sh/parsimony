...
@connector(output=_SEARCH_OUTPUT, tags=["crypto", "search", "tool"])
...
@connector(output=_TRENDING_OUTPUT, tags=["crypto", "search", "tool"])
...
@connector(output=_GAINERS_LOSERS_OUTPUT, tags=["crypto", "search", "tool"])
